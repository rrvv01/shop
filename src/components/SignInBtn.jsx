...
export default function SignInBtn() {
  return (
    <div className="max-w-xl mx-auto grid gap-4 mt-10">
      ...
      >
        <Image src="/google-logo.png" height={30} width={50} alt="google" />
      ...
      >
        <Image src="/github-logo.png" height={30} width={50} alt="github" />
        <span className="bg-gray-700 text-white px-4 py-3 rounded-lg">
          Sign in with Github
        </span>
      </button>
    </div>
